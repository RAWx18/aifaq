...
const ChatBottomBar = ({ onSend }: Props) => {
	...
	return (
		<div className="w-full px-4 max-w-3xl mx-auto">
			<form
				className="flex flex-row p-2 rounded-3xl border items-end gap-2"
			...
			<div className="flex justify-center text-xxs py-1 text-muted-foreground text-center">
				AIFAQ can make mistakes. Check important
				information.
			</div>
		</div>
	);
